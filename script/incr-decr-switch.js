...
let generateShop = () => {
   return (shop.innerHTML = ninSwitch.map((x) => {
      let {id, name, price, descriptLink, img, alt, productDescr, oldprice } = x;
      ...
      <div id=product-id-${id} class="product__container">
            ...
            <div class="product__info">
               <a href="#">
                ...
                <p class="product-short-description">${productDescr}</p>
                <span class="price">${price}</span><span class="actual-price">${oldprice}</span>
            </div> 
